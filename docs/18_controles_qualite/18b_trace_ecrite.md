...
# S18 – Contrôles qualité et vie du produit cosmétique 📖 Trace écrite

---

## 1️⃣ Les 3 stades de vie du produit cosmétique
...
## 3️⃣ Contrôles de tolérance (produit fini)
...
## 4️⃣ Sources de contamination et BPF
...
## 5️⃣ Le vocabulaire E2 des contrôles qualité
...
- ➡️ [**FM03 – Interpréter un graphique ou un tableau**](../Methodologie/03_fiche_methode.md) : pour lire les résultats de stabilité
- ➡️ [**FM01 – Justifier (O.A.C.J.)**](../Methodologie/01_fiche_methode.md) : pour rédiger un avis de conformité
