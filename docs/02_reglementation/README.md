...
➡️ [Télécharger la fiche élève (PDF)](02a_fiche_eleve.pdf)

➡️ [Télécharger la trace écrite (PDF)](02b_trace_ecrite.pdf)

➡️ [Télécharger l'évaluation formative (PDF)](02c_evaluation.pdf)
...
## 🧭 “Carte” pratique de la réglementation
...
## 🔬 “Test rapide” : analyser la conformité d’un produit
...
Attendu typique dans une question d’étude de cas :
- Tu identifies **le texte / la règle** (principe du règlement),
- Tu identifies **l’acteur responsable** (PR / distributeur),
- Tu conclus : **conforme / non conforme** + **mesure logique** (coopération, retrait/rappel, signalement, etc.).

---

## 📺 Pour réviser en vidéo

🎬 **[Règlement (CE) 1223/2009 – bases](https://www.youtube.com/results?search_query=r%C3%A8glement+CE+1223%2F2009+cosm%C3%A9tique+explication)**  
*Objectif : repérer les obligations principales et le rôle de la PR.*

🎬 **[ANSM DGCCRF cosmétiques : rôles](https://www.youtube.com/results?search_query=ANSM+DGCCRF+cosm%C3%A9tiques+r%C3%B4le)**  
*Objectif : savoir qui contrôle quoi et dans quelles situations.*

🎬 **[Cosmétovigilance effets indésirables](https://www.youtube.com/results?search_query=cosm%C3%A9tovigilance+effets+ind%C3%A9sirables+cosm%C3%A9tiques)**  
...
⬅️ Séance précédente : [01 – Diagnostic Qu'est-ce qu'un produit cosmétique ?](../01_Diagnostic/)

➡️ Séance suivante : [03 – Lecture d'un étiquetage cosmétique](../03_Etiquette/)
