---
author: ELP
title: Fiche méthode 16 🌿
---

# Fiche méthode 16 🌿 : Vérifier la **conformité & la sécurité** d’un produit parfumé (IFRA – allergènes – HE) – attendu E2
...
Dans ta progression, la séance **S27 “Parfums et arômes (1/2)”** te demande de mobiliser :
- **voies olfactives**,
...
En E2, on attend que tu sois capable, à partir d’un dossier technique (formule, extrait d’étiquetage, fiche fournisseur, contraintes), de répondre à ce type de questions :

- *« Le produit est-il conforme sur l’aspect “parfum” ? »*
- *« Y a-t-il un risque allergène / HE / phototoxicité ? »*
- *« Quelles mentions doivent apparaître / quelles précautions recommander ? »*

---

## 1️⃣ Ce qu’on attend d’une analyse “parfum” en BTS (niveau E2)

Tu dois être capable de :

| Élément attendu | Ce que tu dois faire |
|----------------|----------------------|
| Identifier le parfumage | repérer **Parfum / Aroma** et les composés parfumants |
| Vérifier l’**étiquetage allergènes** | vérifier si des allergènes (ex : linalool…) doivent être déclarés |
| Comprendre le rôle de l’IFRA | expliquer que l’IFRA fixe des **limites d’usage** selon le type de produit |
| Discuter les risques | HE : **irritation / sensibilisation / phototoxicité** (selon cas) |
| Conclure sans extrapoler | dire ce que les données permettent d’affirmer, et ce qui manque |

---

## 2️⃣ La méthode P.A.R.F.U.M. (à apprendre par cœur)

👉 Une démarche courte, qui marche sur n’importe quel dossier E2.

### 🔹 P – Poser le contexte “produit” (1 phrase)
- produit **rinçage** (rinse-off) ou **non rinçage** (leave-on) ?
...
### 🔹 A – Analyser l’étiquetage / INCI (repérage)
Tu cherches :
- **Parfum** (ou **Aroma**)
...
- sinon tu écris : *« Impossible de conclure sans les teneurs (ou la FDS / fiche allergènes) du parfum. »*
...
- **HE / extraits** = mélanges complexes → plus de variabilité,
- certains procédés concentrent certaines familles moléculaires,
- ça justifie qu’on demande des documents fournisseur (allergènes / IFRA).
...
1) **Sensibilisation / allergie** (réaction cutanée possible)  
2) **Irritation** (selon concentration, zone, peau fragile)  
3) **Phototoxicité** (cas typique : certaines HE d’agrumes riches en furocoumarines → prudence exposition UV)
...
## 3️⃣ Tableau “réflexe” : ce que je vérifie en 60 secondes

| Question | Ce que je cherche dans le dossier | Conclusion possible |
|---------|-----------------------------------|---------------------|
| Produit parfumé ? | “Parfum / Aroma” | Oui/Non |
| Allergènes à déclarer ? | liste INCI + teneurs ou doc parfum | Conforme / non démontrable |
| IFRA ok ? | certificat/attestation IFRA + catégorie | Conforme / manquant |
| HE utilisée ? | mention HE / extrait / MP aromatique | analyser risques (sensibilisant/phototox…) |
| Produit “exposé” ? | leave-on, visage, enfant, lèvres… | exigence de prudence ↑ |

---

## 4️⃣ Modèles de phrases “E2” (prêts à copier)
...
## 7️⃣ Checklist avant de rendre (spécial “parfum”)
...
│   📌 MÉTHODE P.A.R.F.U.M.                           │
│                                                      │
│   P - Produit : rinse-off / leave-on ? zone ?        │
│   A - Analyser l’INCI : Parfum/Aroma + composés      │
│   R - Rechercher allergènes : seuils + preuves       │
│   F - Faire le lien IFRA : certificat + catégorie    │
│   U - Utiliser extraction/MP : cohérence + docs      │
│   M - Mentionner risques HE : irrit./sensib./photo   │
│                                                      │
│   👉 En E2 : conformité = documents + raisonnement  │
│                                                      │
└──────────────────────────────────────────────────────┘
